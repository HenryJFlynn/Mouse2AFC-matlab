...
#from report.splitdata import rngByPerf, rngByQuantile
from report import splitdata
from report.clr import Difficulty as DifficultyClr
from .evdutils import fltrSsns, GroupBy
...
def _processAnimal(animal_name, animal_df, *, plots, min_easiest_perf, exp_type,
  ...
  if plots & Plots.ChronoPsych:
    ...
    analysis.psychAnimalSessions(chron_df, animal_name, PsycStim_axes,
...
def _chronPlot(df, axes, min_sampling_pts, grpby):
  ...
  # if grpby == GroupBy.Performance: kargs["fit_fn_periods"] = 10
  # TODO: Use splitby functions right away
