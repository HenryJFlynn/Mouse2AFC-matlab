...
while true
    ...
    if updateTime == last_updateTime
        ...
        if last_SessStartTime ~= sessStartTime
            ...
            TaskParameters_GUI.RewardAmountCorrect = NaN;
            TaskParameters_GUI.RewardAmountInCorrect = NaN;
            [SessionData.Custom.Trials,...
             SessionData.TrialSettings,...
             SessionData.Timer] = CreateOrAppendDataArray_PredErr(...
        ...
        GUIHandles.OutcomePlot = MainPlot_PredErr(GUIHandles.OutcomePlot,'update',...
            SessionData.Custom, SessionData.TrialSettings(iTrial),...
            SessionData.TrialStartTimestamp(1:iTrial), sessStartTimeDate,...
            iTrial);
        drawnow;
